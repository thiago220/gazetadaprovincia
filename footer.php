                ...
                <div class="row">
                    <div class="col">
                        <a href="https://linkedin.com/company/gazetadaprovincia" target="_blank" title="Gazeta da Província">
                            <img src="<?php echo get_template_directory_uri()."/img/icones/001-linkedin.png"?>" class="d-inline-block align-top" alt="Gazeta da Província">                
                        </a>
                        ...
                        <a href="https://www.instagram.com/gazetadaprovincia/" target="_blank" title="Gazeta da Província">
                            <img src="<?php echo get_template_directory_uri()."/img/icones/004-instagram.png"?>" class="d-inline-block align-top" alt="Gazeta da Província">
                        </a>
                    </div>
                </div>
            </div>
